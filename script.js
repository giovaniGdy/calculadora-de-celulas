function calcular() {
  ...
  if (numero > 0 && diametro > 0) {
    ...
    let quant_n_perfilho = quant_n_colmo * n_perfilho;

    let quant_n_perfilho_formated = quant_n_perfilho.toLocaleString("brl");
    ...
    let quant_area = Math.floor(valor_area / 1.5 / 0.3) * quant_n_perfilho;
